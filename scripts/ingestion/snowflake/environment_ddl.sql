...
CREATE USER IF NOT EXISTS amilton_faria PASSWORD = 'SenhaForte#2025' DEFAULT_ROLE = PUBLIC MUST_CHANGE_PASSWORD = TRUE;
CREATE USER IF NOT EXISTS fernando_bastos PASSWORD = 'SenhaForte#2025' DEFAULT_ROLE = PUBLIC MUST_CHANGE_PASSWORD = TRUE;
CREATE USER IF NOT EXISTS lucas_zago PASSWORD = 'SenhaForte#2025' DEFAULT_ROLE = PUBLIC MUST_CHANGE_PASSWORD = TRUE;
CREATE USER IF NOT EXISTS rodrigo_telles PASSWORD = 'SenhaForte#2025' DEFAULT_ROLE = PUBLIC MUST_CHANGE_PASSWORD = TRUE;
...
ALTER USER rodrigo_telles SET PASSWORD = 'SenhaFraca#2000';
