...
sys.path.append("/opt/airflow/project")  # Adiciona MLET_TC01 ao sys.path
...
def ingest_data():
    ...
    try:
        ...
        print(f"Erro ao ler o CSV {books_csv_path}: {e}")
        return
    ...
    try:
        ...
        print(f"Erro ocorrido durante a inserção: {e}")
        db.rollback()
    finally:
        db.close()
